#ifndef OMICRON_RESOURCE_LOADER_GEOMETRYLOADER_H_
#   define OMICRON_RESOURCE_LOADER_GEOMETRYLOADER_H_
...
inline Geometry* geoFromWavefront(const std::string& filePath) {
